    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2 group">
          ...
          <span className={`font-display text-xl tracking-tighter w-fit h-fit opacity-90 shadow-lg cursor-pointer uppercase font-black ${scrolled ? 'text-primary' : 'text-white drop-shadow-md'}`}>
            Makarenko
          </span>
        </a>
